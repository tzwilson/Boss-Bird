...
@Override
    public void onCreate(Bundle savedInstanceState) {
		...
		leaderboards.setBackgroundColor(Color.TRANSPARENT);
		...
		achievements.setBackgroundColor(Color.TRANSPARENT);
	...
	public void onClick(View v) {
	    ...
	    if (v.getId() == leaderboards.getId()) {
	    	if(gHelp.isSignedIn() == true){
	    			Games.Leaderboards.submitScore(gHelp.getApiClient(), ldrkey, GameWorld.score2);
